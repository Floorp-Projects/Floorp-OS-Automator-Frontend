        ...
        <Box w="full" maxW="3xl">
          ...
          {!isSearching && (
            <VStack gap={6} textAlign="center" py={8}>
              ...
              <HStack gap={2} justify="center" flexWrap="wrap" w="full">
                <Button
                  ...
                  borderColor="border"
                  color="fg.muted"
                  _hover={{ bg: "bg.muted", color: "fg", borderColor: "border.emphasized" }}
                >
                  <LuSparkles size={14} />
                ...
                >
                  <LuSettings size={14} />
                  <Text fontSize="sm">{t("common.settings")}</Text>
                </Button>
              </HStack>
            </VStack>
          )}
            ...
            <VStack gap={2} w="full" py={4}>
              <HStack justify="space-between" w="full" px={1}>
                <Text fontSize="sm" color="fg.muted" fontWeight="medium">
                  {t("common.similarWorkflows")} ({filteredWorkflows.length})
                </Text>
                {hasMoreWorkflows && (
                  <Button
                    size="xs"
              ...
              {hasWorkflows && !loading && displayWorkflows.map((workflow) => {
